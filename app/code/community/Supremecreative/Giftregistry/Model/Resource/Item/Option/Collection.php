...
/**
 * Giftregistry item option collection
 *
 * @category    Supremecreative
 * @package     Supremecreative_Giftregistry
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Supremecreative_Giftregistry_Model_Resource_Item_Option_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
    ...
    {
        $this->_init('giftregistry/item_option');
    }

    /**
     * Fill array of options by item and product
     *
     * @return Supremecreative_Giftregistry_Model_Resource_Item_Option_Collection
     */
    protected function _afterLoad()
    {
        ...
        foreach ($this as $option) {
            ...
            $itemId     = $option->getGiftregistryItemId();
    ...
    public function addItemFilter($item)
    {
        if (empty($item)) {
            ...
            $this->addFieldToFilter('giftregistry_item_id', array('in' => $item));
        } else if ($item instanceof Supremecreative_Giftregistry_Model_Item) {
            $this->addFieldToFilter('giftregistry_item_id', $item->getId());
        } else {
            $this->addFieldToFilter('giftregistry_item_id', $item);
        }
