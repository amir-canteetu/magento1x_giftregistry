 ...
 */
class Supremecreative_Giftregistry_Model_Resource_Item_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
    ...
    protected function _assignOptions()
    {
        ...
        /* @var $optionCollection Supremecreative_Giftregistry_Model_Resource_Item_Option_Collection */
        $optionCollection = Mage::getModel('giftregistry/item_option')->getCollection();
    ...
    {
        Varien_Profiler::start('GIFTREGISTRY:'.__METHOD__);
        $productIds = array();
        ...
        $attributes = Mage::getSingleton('giftregistry/config')->getProductAttributes();
        ...
        Mage::dispatchEvent('giftregistry_item_collection_products_after_load', array(
        ...
        Varien_Profiler::stop('GIFTREGISTRY:'.__METHOD__);

        return $this;
    }

    /**
     * Add filter by giftregistry object
     *
    ...
    {
        $this->addFieldToFilter('giftregistry_id', $giftregistry->getId());
        return $this;
    }
    ...
    public function addCustomerIdFilter($customerId)
    {
        $this->getSelect()
            ->join(
                array('giftregistry' => $this->getTable('giftregistry/giftregistry')),
                'main_table.giftregistry_id = giftregistry.giftregistry_id',
                array()
            )
            ->where('giftregistry.customer_id = ?', $customerId);
        return $this;
    }
    ...
    /**
     * Adds filter on days in giftregistry
     *
    ...
    public function getItemsQty(){
        if (is_null($this->_itemsQty)) {
            $this->_itemsQty = 0;
            foreach ($this as $giftregistryItem) {
                $qty = $giftregistryItem->getQty();
