...
/**
 * Giftregistry item model
 *
 * @method Supremecreative_Giftregistry_Model_Resource_Item getResource()
 * @method int getGiftregistryId()
 * @method Supremecreative_Giftregistry_Model_Item setGiftregistryId(int $value)
 * @method int getProductId()
 * @method Supremecreative_Giftregistry_Model_Item setProductId(int $value)
 * @method int getStoreId()
 * @method Supremecreative_Giftregistry_Model_Item setStoreId(int $value)
 * @method string getAddedAt()
 * @method Supremecreative_Giftregistry_Model_Item setAddedAt(string $value)
 ...
 */
class Supremecreative_Giftregistry_Model_Item extends Mage_Core_Model_Abstract
    implements Mage_Catalog_Model_Product_Configuration_Item_Interface
{
     ...
     * @var string
     */
    protected $_customOptionDownloadUrl = 'giftregistry/index/downloadCustomOption';
   ...
   /**
    ...
    {
        $this->_cacheTag = 'giftregistry_item';
     ...
     *
     * @return Supremecreative_Giftregistry_Model_Mysql4_Item
     */
     ...
     *
     * @param   Supremecreative_Giftregistry_Model_Item_Option $option
     * @return  Supremecreative_Giftregistry_Model_Item
     */
    ...
    /**
     * Validate gift registry item data
     *
    ...
    {
        if (!$this->getGiftregistryId()) {
            Mage::throwException(Mage::helper('giftregistry')->__('Cannot specify giftregistry.'));
        }
        if (!$this->getProductId()) {
            Mage::throwException(Mage::helper('giftregistry')->__('Cannot specify product.'));
        }
     ...
     * @return Supremecreative_Giftregistry_Model_Item
     */
    public function loadByProductGiftregistry($giftregistryId, $productId, $sharedStores)
    {
        $this->_getResource()->loadByProductGiftregistry($this, $giftregistryId, $productId, $sharedStores);
        $this->_afterLoad();
        $this->setOrigData();
    ...
    public function getProduct()
    {
        ...
        if (is_null($product)) {
            if (!$this->getProductId()) {
                throw new Mage_Core_Exception(Mage::helper('giftregistry')->__('Cannot specify product.'),
    ...
    {
        if (is_array($option)) {
            $option = Mage::getModel('giftregistry/item_option')->setData($option)
                ->setItem($this);
        } else if ($option instanceof Supremecreative_Giftregistry_Model_Item_Option) {
            $option->setItem($this);
        } else if ($option instanceof Varien_Object) {
            $option = Mage::getModel('giftregistry/item_option')->setData($option->getData())
     ...
     *
     * @param   string $code
     * @return  Supremecreative_Giftregistry_Model_Item_Option || null
     */
    ...
    public function loadWithOptions($id, $optionsFilter = null)
    {
        ...
        $options = Mage::getResourceModel('giftregistry/item_option_collection')
            ->addItemFilter($this);
        if ($optionsFilter) {
