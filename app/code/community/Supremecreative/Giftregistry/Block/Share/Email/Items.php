 ...
 */
class Supremecreative_Giftregistry_Block_Share_Email_Items extends Supremecreative_Giftregistry_Block_Abstract
{
    /**
     * Initialize template
     *
    ...
    {
        parent::__construct();
        $this->setTemplate('giftregistry/email/items.phtml');
    }
    ...
    public function hasDescription($item)
    {
        ...
        if ($hasDescription) {
            return ($item->getDescription() !== Mage::helper('giftregistry')->defaultCommentString());
        }
