...
/**
 * Giftregistry block customer item column
 *
 * @category    Supremecreative
 * @package     Supremecreative_Giftregistry
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Supremecreative_Giftregistry_Block_Customer_Giftregistry_Item_Column extends Supremecreative_Giftregistry_Block_Abstract
{
    /**
