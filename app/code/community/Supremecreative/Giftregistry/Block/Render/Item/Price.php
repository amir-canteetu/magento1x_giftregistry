...
/**
 * Giftregistry block for rendering price of item with product
 *
 * @category   Mage
 * @package    Supremecreative_Giftregistry
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Supremecreative_Giftregistry_Block_Render_Item_Price extends Mage_Core_Block_Template
{
    /**
